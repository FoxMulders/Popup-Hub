...
## Next actions
1. **Deploy** round-table + table-size + placement fixes; smoke-test pill → draw footprint (rect + round) + booth/wall/stage inside room on Step 3 + `/coordinator/events/[id]/layout` + dashboard
