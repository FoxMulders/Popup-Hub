...
## Active work — Critical bug scan: is_test catalog leak (PR pending)
- **Trigger:** Push `df577fe5` (session handoff docs); substantive recent surface area is ship 45/46 scenario test markets + public catalog queries.
...
- **Branch:** `cursor/critical-bug-investigation-d952`
- **Next:** Merge PR → deploy → confirm scenario markets absent from `/discover`.
