...
REM Next commit (auto): feat: ship 2 session updates (initial loader side booth stagger + right-align scale; dual-screen presenter vs wall-cast differentiation)
REM
