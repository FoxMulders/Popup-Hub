...
REM Next commit (auto): feat: ship 82 session updates (CI master lint fix; Fairness-first layout polygon fix; Traffic-aware auto-arrange greyed out fix; floor plan empty-grid marquee + crosshair; +78 more)
REM
