...
REM Next commit (auto): feat: ship 43 session updates (booth payment card form fix; sticky site footer; polygon room reshape; vendor apply event not found fix; +39 more)
REM
