...
REM Next commit (auto): feat: ship 14 session updates (Mobile login chrome dedupe; Outdoor markets (tent vendors + fixtures); HubGrid canvas layout redesign; Center/align toolbar placement; +10 more)
REM
