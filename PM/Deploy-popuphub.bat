...
REM Next commit (auto): feat: ship 23 session updates (Auth + native splash cleanup; Header wordmark swap; Popup Hub logo vector recreation; Mobile footer link trim; +19 more)
REM
