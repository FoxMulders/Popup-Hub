...
REM Next commit (auto): feat: ship 153 session updates (Location Tent brand logo refresh; semver sync from release history; HubGuard claim matching + Visual/UI §3; CRO user journeys §2; +149 more)
REM
