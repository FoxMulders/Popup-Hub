...
REM Next commit (auto): feat: ship 46 session updates (Public event TypeScript CI fix; Signup role selection + questionnaire; Market detail footer clearance; Center loader logo and animation; +42 more)
REM
