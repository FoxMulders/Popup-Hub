...
REM Next commit (auto): feat: ship 109 session updates (FAQ and help copy refresh; app icon full logo restore; modern brand refresh; AI Auto-Arrange UI freeze fix; +105 more)
REM
