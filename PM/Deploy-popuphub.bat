...
REM Next commit (auto): feat: ship 63 session updates (setup wizard step URL refresh fix; vendor contract signing; coordinator saved layouts; fill room with tables; +59 more)
REM
