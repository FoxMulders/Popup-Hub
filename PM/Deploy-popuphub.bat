...
REM Next commit (auto): feat: ship 45 session updates (Signup role selection + questionnaire; Market detail footer clearance; Center loader logo and animation; Popup Hub empty-state copy; +41 more)
REM
