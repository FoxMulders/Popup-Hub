...
REM Next commit (auto): feat: ship 25 session updates (wizard Step 2 single-column layout; publish blocked by server Geocoding key; booth validation: physical overlap vs boundary warnings; middle-mouse grid pan; +21 more)
REM
