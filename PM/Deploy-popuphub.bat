...
REM Next commit (auto): feat: ship 24 session updates (publish blocked by server Geocoding key; physical overlap vs clearance buffer; middle-mouse grid pan; dashboard canvas edge-to-edge grid; +20 more)
REM
