...
REM Next commit (auto): feat: ship 135 session updates (Canopy trust directory rebrand; patron navigation, location, organizer UX; quarter auction setup parity; organizer list growth; +131 more)
REM
