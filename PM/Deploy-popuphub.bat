...
REM Next commit (auto): feat: ship 46 session updates (map labels dropdown width; booth payment read-only in matrix; Square OAuth scope encoding fix; sticky site footer; +42 more)
REM
