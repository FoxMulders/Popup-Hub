...
REM Next commit (auto): feat: ship 106 session updates (AI Auto-Arrange UI freeze fix; mobile maps + Google directions; fairness capacity / coverage / fairness split; Windows webpack build worker crash; +102 more)
REM
