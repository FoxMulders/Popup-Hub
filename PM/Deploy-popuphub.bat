...
REM Next commit (auto): feat: ship 21 session updates (Popup Hub logo vector recreation; Mobile footer link trim; Native Google OAuth; iOS routing coverage GeoJSON; +17 more)
REM
