...
REM Next commit (auto): feat: ship 81 session updates (Fairness-first layout polygon fix; Traffic-aware auto-arrange greyed out fix; floor plan empty-grid marquee + crosshair; test suite seed redirect fix; +77 more)
REM
