...
REM Next commit (auto): feat: ship 23 session updates (physical overlap vs clearance buffer; middle-mouse grid pan; dashboard canvas edge-to-edge grid; wizard step scroll-to-top; +19 more)
REM
