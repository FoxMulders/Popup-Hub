...
REM Next commit (auto): feat: ship 24 session updates (Logo revert to attachment artwork + auth logo removal; Auth + native splash cleanup; Header wordmark swap; Popup Hub logo vector recreation; +20 more)
REM
