...
REM Next commit (auto): feat: ship 22 session updates (middle-mouse grid pan; dashboard canvas edge-to-edge grid; wizard step scroll-to-top; wizard venue template sync on venue pick; +18 more)
REM
