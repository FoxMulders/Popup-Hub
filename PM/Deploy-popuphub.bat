...
REM Next commit (auto): feat: ship 145 session updates (coordinator market load crash; flyer cover upload click regression; patron UX + coordinator polish; create market single scroll; +141 more)
REM
