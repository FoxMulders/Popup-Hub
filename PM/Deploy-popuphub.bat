...
REM Next commit (auto): feat: ship 41 session updates (polygon room reshape; vendor apply event not found fix; apply dialog viewport fit; automatic image compression for uploads; +37 more)
REM
