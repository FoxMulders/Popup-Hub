...
REM Next commit (auto): feat: ship 98 session updates (auto-arrange button feedback; remove Arrange layout buttons; layout help in site nav; CI lint fix simulated-annealing; +94 more)
REM
