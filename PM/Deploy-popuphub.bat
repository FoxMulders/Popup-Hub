...
REM Next commit (auto): feat: ship 48 session updates (CI lint fix; manual layout orientation pattern; map labels dropdown width; booth payment read-only in matrix; +44 more)
REM
