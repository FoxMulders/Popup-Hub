...
REM Next commit (auto): feat: ship 117 session updates (layout tutorial room shape step; passport featured products nav; AI auto-arrange page freeze; patron table fill capacity; +113 more)
REM
