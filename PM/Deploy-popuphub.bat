...
REM Next commit (auto): feat: ship 138 session updates (patron UX + coordinator polish; HubGuard rebrand; HubGuard booth-fee headline; mobile discover UX polish; +134 more)
REM
