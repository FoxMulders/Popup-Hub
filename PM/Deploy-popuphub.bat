...
REM Next commit (auto): feat: ship 115 session updates (layout tutorial room shape step; patron table fill capacity; layout auto-tour opt-out; share contact with vendors label; +111 more)
REM
