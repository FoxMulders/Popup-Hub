...
REM Next commit (auto): feat: ship 119 session updates (favicon icon mark only; passport niche tags + MLM gating; layout tutorial room shape step; passport featured products nav; +115 more)
REM
