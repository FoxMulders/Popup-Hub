...
REM Next commit (auto): feat: ship 80 session updates (Traffic-aware auto-arrange greyed out fix; floor plan empty-grid marquee + crosshair; test suite seed redirect fix; Vendor Fairness Layout Engine; +76 more)
REM
