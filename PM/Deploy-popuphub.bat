...
REM Next commit (auto): feat: ship 47 session updates (manual layout horizontal default; map labels dropdown width; booth payment read-only in matrix; Square OAuth scope encoding fix; +43 more)
REM
