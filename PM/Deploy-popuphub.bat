...
REM Next commit (auto): feat: ship 44 session updates (Center loader logo and animation; Popup Hub empty-state copy; Uniform platform feature cards; Scenario test markets (`is_test`); +40 more)
REM
