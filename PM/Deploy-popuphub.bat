...
REM Next commit (auto): feat: ship 39 session updates (Feature request resolution notes  reopen; Category max-slots input fix; MLM broad category pinned first; Capacity step skip-layout copy; +35 more)
REM
