...
REM Next commit (auto): feat: ship 148 session updates (HubGrid canvas INP; HubGrid minimal footer + fullscreen viewport + clearance tint fix; coordinator market load crash; flyer cover upload click regression; +144 more)
REM
