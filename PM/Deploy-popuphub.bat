...
REM Next commit (auto): feat: ship 118 session updates (passport niche tags + MLM gating; layout tutorial room shape step; passport featured products nav; AI auto-arrange page freeze; +114 more)
REM
