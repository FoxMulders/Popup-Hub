...
REM Next commit (auto): feat: ship 25 session updates (wizard Step 2 single-column layout; publish blocked by server Geocoding key; physical overlap vs clearance buffer; middle-mouse grid pan; +21 more)
REM
