...
REM Next commit (auto): feat: ship 56 session updates (reinstate vendor spacing clearance warnings; zoom in/out regression fix; remove legacy join/merge and stage tools; layout editor help search; +52 more)
REM
