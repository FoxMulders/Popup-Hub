...
REM Next commit (auto): feat: ship 116 session updates (layout tutorial room shape step; AI auto-arrange page freeze; patron table fill capacity; layout auto-tour opt-out; +112 more)
REM
