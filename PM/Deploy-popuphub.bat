...
REM Next commit (auto): feat: ship 154 session updates (Location Tent brand logo refresh; semver sync from release history; CRO performance  friction §4; HubGuard claim matching + Visual/UI §3; +150 more)
REM
