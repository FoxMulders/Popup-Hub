...
export const ABOUT_CLOSING = `We've built something incredible here to lift everyone up together, drive real traffic to our events, and make the hustle worth it. Let's keep it fair, keep it honest, and continue building a stronger, more connected market community.

Thank you for your trust, your hard work, and for being a part of this journey.`

export const ABOUT_SIGNATURE = 'The Tipsy Fox — Sonia & Brad M.'
