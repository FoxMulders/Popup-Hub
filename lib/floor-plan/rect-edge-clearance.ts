...
/**
 * Aisle clearance between two vendor booths — only horizontal or vertical
 * neighbors (shared row or column). Purely diagonal pairs are ignored so a
 * corner booth does not tint the opposite corner red/yellow.
 */
