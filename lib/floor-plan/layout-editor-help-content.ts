...
export const LAYOUT_EDITOR_HELP_TOPICS: LayoutEditorHelpTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Open Layout help from the site header (green button) or press ? to search topics.',
    ],
    keywords: [
      'start',
      'introduction',
  ...
  },
  {
    ...
    category: 'optimize',
    title: 'AI Auto-Arrange floor plan',
    summary:
      'Automatically position vendor booths and patron tables inside the active room.',
    steps: [
      'Place tables with Vendor Booths or Patron Tables before auto-arranging — generic Shapes do not count.',
      'Grid mode works without doors; Perimeter and Staggered modes need entry + exit on walls.',
      'Choose a pattern: Grid, Staggered, or Perimeter.',
      'Click AI Auto-Arrange — existing objects in the room are repositioned.',
      'Review Cap · Cov · Fair scores, clearance warnings, and overlaps after auto-arrange; tweak manually if needed.',
    ],
    keywords: [
      'auto arrange',
      'ai auto-arrange',
