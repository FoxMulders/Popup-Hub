  ...
  return (
    <div className="flex flex-col items-center gap-4 py-2">
      <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
        <QrCode className="h-4 w-4 text-harvest-500" />
      ...
      <div
        ref={svgRef}
        className="rounded-xl border-2 border-stone-200 p-3 bg-white shadow-sm"
      >
      ...
      <div className="text-center space-y-0.5">
        <p className="font-semibold text-foreground text-sm">{eventName}</p>
        {boothNumber != null && (
          <p className="text-xs text-harvest-600 font-medium">Booth #{boothNumber}</p>
        )}
      </div>
