...
function SpatialLayoutEditorInner({
  ...
  const eventLocationName = event.location_name
  ...
  return (
    <>
      ...
      >
        {showDesktopRequired ? (
          <div className="flex h-full min-h-[40vh] items-center justify-center p-6 text-center">
            <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
              Booth layout needs a tablet in landscape or a desktop monitor. Save your market and
              continue designing on a larger screen.
            </p>
          </div>
        ) : (
          <FloorPlanV2
            ...
            designerExitEventStatus={eventStatus}
