        ...
        {showDesktopRequired ? (
          <div className="flex min-h-[40vh] flex-col items-center justify-center gap-4 p-6 text-center">
            <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
              Booth layout needs a tablet or desktop. Save your layout draft now and continue
              designing on a larger screen.
            </p>
            <button
              type="button"
            ...
            >
              {savingDraft ? 'Saving...' : 'Save draft & pick up on desktop'}
            </button>
          </div>
        ) : (
          <FloorPlanV2
