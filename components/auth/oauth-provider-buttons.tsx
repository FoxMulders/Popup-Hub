...
const PROVIDER_ICONS: Record<OAuthProviderId, () => React.ReactElement> = {
  google: GoogleIcon,
  apple: AppleIcon,
  azure: MicrosoftIcon,
...
type OAuthProviderButtonsProps = {
  ...
  disabled?: boolean
  onSignIn: (provider: OAuthProviderId) => void
...
export function OAuthProviderButtons({
  ...
  disabled = false,
  onSignIn,
  providers = OAUTH_PROVIDER_ORDER,
  className,
      ...
      {providers.map((providerId) => {
        ...
        return (
          <Button
            ...
            type="button"
            disabled={disabled || (isBusy && !isPending)}
          >
