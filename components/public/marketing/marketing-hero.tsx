...
import { MarketingHeroPathways } from '@/components/public/marketing/marketing-hero-pathways'
  ...
  return (
    <section className="relative overflow-hidden marketing-hero-mesh text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-16 sm:py-24 lg:py-28">
        ...
        <MarketingHeroPathways />
        <p className="mt-8 text-center text-xs font-medium tracking-wide text-white/60">
          {HOME_HERO.footerLine}
        </p>
      </div>
