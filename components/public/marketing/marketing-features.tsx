...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'Community vouching, reliability signals, and clear transaction history for vendors and organizers.',
  },
  {
    icon: Store,
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <ul className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map(({ icon: Icon, title, description }) => (
            <li
              key={title}
              className="marketing-glass-card flex flex-col p-6 transition-shadow hover:shadow-[var(--shadow-market-hover)]"
            >
