...
import { EXTERIOR_LABEL_OFFSET_PX, objectCenter } from '@/components/coordinator/floor-plan-v2/interactions/geometry'
import { BOOTH_EQUIPMENT_DEPTH_FT } from '@/lib/booth-planner/table-space'
import { boothHasTableCluster } from '@/components/coordinator/floor-plan-v2/state/table-cluster-layout'
import { PERIMETER_WALL_LABEL } from '@/components/coordinator/floor-plan-v2/interactions/perimeter-walls'
import { PLACEMENT_VIOLATION } from '@/components/coordinator/floor-plan-v2/canvas/placement-theme'
import {
  BOOTH_STATUS_THEME,
...
export const CanvasObjectsQa = memo(CanvasObjectsBase)
