...
import { useCanvasPointer, resolveDrawCommitRect } from '@/components/coordinator/floor-plan-v2/interactions/use-canvas-pointer'
import {
...
export function FloorPlanCanvasDashboardQa({
  store,
  toolState,
  activeRoomId,
  selectedRoomId,
