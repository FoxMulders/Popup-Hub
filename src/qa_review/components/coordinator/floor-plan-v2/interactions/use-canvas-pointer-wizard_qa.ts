...
import {
  allowsWizardPlacementWithoutRoom,
  findRoomIdForPlacementPointWizardQa,
  isValidPlacementLocationWizardQa,
} from '@/src/qa_review/lib/floor-plan/placement-validation-wizard_qa'
...
export function useCanvasPointerWizardQa(
