...
import { marketCityLatLngBoundsLiteral } from '@/src/qa_review/lib/wizard/wizard-places-bounds_qa'
import type { WizardPlacesAutocompleteMode } from '@/src/qa_review/lib/wizard/places-autocomplete-request_qa'

export interface UseGooglePlacesAutocompleteWidgetQaOptions {
 ...
 */
export function useGooglePlacesAutocompleteWidgetQa({
  mode,
  cityId,
  onPlaceChanged,
  onApiStatus,
}: UseGooglePlacesAutocompleteWidgetQaOptions) {
