              ...
              {upcomingEvents.map((event) => (
                <div key={event.id} className="relative">
                  ...
                  <div className="absolute right-3 top-3 z-10">
                    <FavoriteButton eventId={event.id} initialFavorited size="sm" iconOnly className="h-9 w-9 rounded-full bg-white/95 p-0 shadow-sm" />
                  </div>
                </div>
              ))}
            </div>
                ...
                >
                  ...
                  {upcoming ? (
                    <Link
                      ...
                      className="block text-sm text-forest underline"
                    >
                    ...
                    <p className="text-xs text-muted-foreground">No upcoming approved markets yet.</p>
                  )}
                </li>
              )
            })}
